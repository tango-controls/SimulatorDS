...
#------------------------------------------------------------------
    def DbAddDevice(self, argin):
        ...
        self.info_stream("DataBase::AddDevice(): insert " + argin[0] + " server with device " + str(argin[1]))
...
#------------------------------------------------------------------
    def DbExportDevice(self, argin):
        ...
        :return: 
        :rtype: PyTango.DevVoid """
        self.debug_stream("In " + self.get_name() + ".DbExportDevice(%s)"%str(argin))
...
#------------------------------------------------------------------
    def DbGetClassProperty(self, argin):
        ...
        try:
            ...
            class_name = argin[0]
            argout = self.db.get_class_property(class_name,argin[1:])
...
#------------------------------------------------------------------
    def DbGetDeviceAttributeProperty2(self, argin):
        ...
        Str[n + m] = Attribute property 2 value (array case)
        :rtype: PyTango.DevVarStringArray """
        self.debug_stream("In " + self.get_name() + ".DbGetDeviceAttributeProperty2(%s)"%argin)
        try:
            argout = ['']
            ...
            dev_name = argin[0]
            argout = self.db.get_device_attribute_property2(dev_name, argin[1:])
            time_after = time.time()
...
#------------------------------------------------------------------
    def DbGetProperty(self, argin):
        ...
        object_name = argin[0]
        argout = map(str,self.db.get_property(object_name, argin[1:]))
        print object_name,argin[1:]
        print argout
...
#------------------------------------------------------------------
    ...
    def DbPutClassProperty(self, argin):
        ...
        self.db.put_class_property(class_name, int(nb_properties), argin[2:])
...
#------------------------------------------------------------------
    def DbPutDeviceAttributeProperty(self, argin):
        ...
        :return: 
        :rtype: PyTango.DevVoid """
        self.debug_stream("In " + self.get_name() + ".DbPutDeviceAttributeProperty(%s)"%str(argin))
...
#------------------------------------------------------------------
    def DbPutDeviceAttributeProperty2(self, argin):
        ...
        :return: 
        :rtype: PyTango.DevVoid """
        self.debug_stream("In " + self.get_name() + ".DbPutDeviceAttributeProperty2(%s)"%str(argin))
        ...
        try:
            ...
            self.db.put_device_attribute_property2(device_name, int(nb_attributes), argin[2:])
...
#------------------------------------------------------------------
    def DbPutDeviceProperty(self, argin):
        ...
        :return: 
        :rtype: PyTango.DevVoid """
        self.info_stream("In " + self.get_name() + ".DbPutDeviceProperty()")
        ...
        self.db.put_device_property(device_name, nb_properties, properties)
...
#------------------------------------------------------------------
    def DbMySqlSelect(self, argin):
        ...
        if pos == -1 and not tmp_argin.startswith('show') and not tmp_argin.startswith('.'):
            cmd = "SELECT " + cmd
